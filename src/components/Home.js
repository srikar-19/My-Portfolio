...
window.onscroll = function() {
  ...
  function topFunction() {
    ...
    return(
        <div className='BackgroundDiv2 BackgroundDivImg Home container-fluid text-center'>
            {/* Arrow Up */}
            ...
            <div className="PhotoSigIntro row row-cols-2 row-cols-md-2 row row-cols-sm-1 mb-5" id='home'>
                {/* Photo-Signature */}
                <div className="PhotoSig col-12 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xxl-5 border-2">
                    <div className='PhotoSigContent'>
                        <div className="Photo">
                            ...
                            <img src={Profile} className='Profile1 avatar image-fluid mb-2' alt="" />
                ...
                <div className="Intro col-12 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xxl-7 ms-0">
                    <div className="IntroContent">
                        <h3 className="Name mt-5">Hi, I'm Srikar.</h3>
                    </div>
                    ...
                    <div className={`OffCanvasContent offcanvas offcanvas-end bg-dark text-white text-center ${isOffCanvasOpen?'show':''}`} id="sidebar">
                        <div className="OffCanvasHeader offcanvas-header d-flex justify-content-between w-100 w-xl-80 w-lg-70 m-md-50 w-sm-30 mt-3">
                            ...
                            <div className="mt-5 mb-0">
                                <img src={Profile} className='Profile2' alt="" />
            ...
            <div className="downloadResume">
                <div className='downloadButton'>
                            <div>
                                <button className='btn btn-dark p-3 DownloadBtn'><a className='Download' href="https://drive.google.com/file/d/1-OcW_NPmuerOYfTaT5DGPxGLyjXz131-/view?usp=sharing" target='_blank' style={{textDecoration:"None",fontSize:"19px",letterSpacing:'.7px',color:"cadetblue", fontFamily:''}}>Download My Resume <FontAwesomeIcon icon={faFileArrowDown} shake className='ms-2' style={{color:'#5dff43'}} size='xl'/></a></button>
                            </div>
                </div>
            </div>
            {/* Footer */}
            <footer className='Footer container-fluid text-white bg-dark text-center text-lg-start text-white' style={{width:"100vw",marginLeft:"-25px",marginRight:"-25px",padding:"0px"}}>
                <section className='Section1 text-center row row-cols-1 p-4 ps-5'>
                    ...
                    <div className='text-center row row-cols-1'>
                        <div className='col-12 col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12'>
                            <a href="https://www.facebook.com/sabbanisaisrikar" target='_blank' className="me-4 text-decoration-none col-12 col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                <span className='text-secondary'>Facebook</span>
                                <FontAwesomeIcon icon={faFacebook} beat className='ms-2 me-2'/>
                            </a>
                        </div>
                        <div className='col-12 col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12'>
                            <a href="https://twitter.com/SabbaniSrikar" target='_blank' className="me-4 text-decoration-none col-12 col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                <span className='text-secondary'>Twitter</span>
                                <FontAwesomeIcon icon={faTwitter} beat className='ms-2 me-2' />
                            </a>
                        </div>
                        <div className='col-12 col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12'>
                            <a href="mailto:svsaisrikar@gmail.com" className="me-4 text-decoration-none col-12 col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                <span className='text-secondary'>Google</span>
                                <FontAwesomeIcon icon={faGoogle} beat className='ms-2 me-2' style={{color:"#d11f00"}} />
                            </a>
                        </div>
                        <div className='col-12 col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12'>
                            <a href="https://www.instagram.com/srikar.sabbani/" target='_blank' className="me-4 text-decoration-none col-12 col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        ...
                        <div className='col-12 col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12'>
                            <a href="https://github.com/srikar-19" target='_blank' className="text-decoration-none col-12 col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 me-4">
                    ...
                    <div className="container-fluid text-center text-md-start mt-5">
                        <div className="row mt-3">
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto">
                                <h6 className="footerDesc1 mb-4">
                                    <i className=""></i>S V SAI SRIKAR
                                </h6>
                                <p className='footerDesc2'>
                                    An Undergraduate student pursuing B.tech(CSE) in VNR VIGNANA JYOTI INSTITUTE OF ENGINEERING AND TECHNOLOGY (2020-2024)<br></br>
                                </p>
                            </div>
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                <h6 className="mb-4 footerDesc1">CONTACT :</h6>
                                <p className='footerDesc2'>Kakatiya nagar colony, 16 Portions, Kamareddy (503111)</p>
                                <div>
                                    <i className="fas fa-envelope"></i>
                                    <a href="mailto:svsaisrikar@gmail.com" className='text-decoration-none footerDesc3'>svsaisrikar@gmail.com</a>
                                </div>
                                <div>
                                    <i className="fas fa-envelope"></i>
                                    <a href="tel:+918688136822" className='text-decoration-none footerDesc3'>+91 8688136822</a>
                                </div>
                            </div>
                        </div>
                    </div>
